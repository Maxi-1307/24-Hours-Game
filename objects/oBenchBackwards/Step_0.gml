if (global.CanMove && (!instance_exists(oTextBox)) && oPlayer.sprite_index != sprPlayerSittingWind && (!instance_exists(oInventory))) {
            ...
            with(_tb) {
                ...
                decision_script[1] = {
                    left: function() {
                        ...
                        oPlayer.sprite_index = sprPlayerSittingWind;
...
if (oPlayer.sprite_index == sprPlayerSittingWind && oPlayer.x == x && oPlayer.y == y - 17) {
