...
if (speaker_sprite[page] != noone) {
    ...
    var scale_x = (31 / sw) * cam_scale_x;
    var scale_y = (31 / sh) * cam_scale_y;
    draw_sprite_ext(spr, 0,box_draw_x + portrait_x_offset[page] * cam_scale_x,box_draw_y,scale_x, scale_y, 0, c_white, 1);
}
